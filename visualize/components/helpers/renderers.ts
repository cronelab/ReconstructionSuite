...
import { UtilsCore, orthographicCameraFactory, trackballOrthoControlFactory } from 'ami'; // Import AMI (from TheBrainChain repo)
...
class R0 {
  ...
  camera: typeof CamerasOrthographic;
  renderer: WebGLRenderer;
  scene: Scene;
  domElement: HTMLElement;

  constructor(domId, targetID){
    this.domId = domId;
    this.targetID = targetID;
  }
}
export const r0 = new R0('r0',0);

class Rx {
  domId: string;
  sliceOrientation: string;
  targetID: number;
  controls: typeof ControlsOrthographic;
  light: DirectionalLight;
  camera: typeof CamerasOrthographic;
  renderer: WebGLRenderer;
  scene: Scene;
  stackHelper: any;
  domElement: HTMLElement;
  constructor(domId, sliceOrientation, targetID){
    this.domId = domId;
    this.sliceOrientation = sliceOrientation;
    this.targetID = targetID;
  }
}
export const r1 = new Rx('r1','axial',1);
export const r2 = new Rx('r2','sagittal',2);
export const r3 = new Rx('r3','coronal',3);
