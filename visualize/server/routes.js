...
const routes = (express) => {
  ...
  router.get('/data/:subject', (req, res) => {
    let subject = req.params.subject;
    console.log(subject);
    if (fs.existsSync(`/home/visualizer/data/derivatives/seekviz/${subject}/seekvizTest.json`)) {
      console.log(subject);
      res.sendFile(`seekvizTest.json`, {
        root: `/home/visualizer/data/derivatives/seekviz/${subject}`,
      });
    } else {
      res.status(404).send('Not Found');
    }
  ...
  //datasets
  router.get('/data/list/:subject', (req, res) => {
    let subject = req.params.subject;
    if (!fs.existsSync(`/home/visualizer/data/derivatives/seekviz/${subject}`)) {
      fs.mkdirSync(`/home/visualizer/data/derivatives/seekviz/${subject}`);
    }
    let _records = fs.readdirSync(`/home/visualizer/data/derivatives/seekviz/${subject}`);
