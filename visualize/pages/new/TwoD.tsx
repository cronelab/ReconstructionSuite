...
const TwoD = () => {
  ...
  async function init() {
    ...
    renderTarget.texture = renderTargetTexture
    ...
    const brainReq = await fetch(`/api/subject/CC_1?modality=reconstruction`);
    ...
    const texture = new THREE.DataArrayTexture(data, 256, 256, 256);
